...
namespace Project_View.ServicioParticipante {
    ...
    public interface IParticipantesWebService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IParticipantesWebService/FiltList", ReplyAction="http://tempuri.org/IParticipantesWebService/FiltListResponse")]
        AccesoDatos.Entidades.Participante[] FiltList(AccesoDatos.Entidades.Participante oparti);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IParticipantesWebService/FiltList", ReplyAction="http://tempuri.org/IParticipantesWebService/FiltListResponse")]
        System.Threading.Tasks.Task<AccesoDatos.Entidades.Participante[]> FiltListAsync(AccesoDatos.Entidades.Participante oparti);
    }
    ...
    public partial class ParticipantesWebServiceClient : System.ServiceModel.ClientBase<Project_View.ServicioParticipante.IParticipantesWebService>, Project_View.ServicioParticipante.IParticipantesWebService {
        ...
        public AccesoDatos.Entidades.Participante[] FiltList(AccesoDatos.Entidades.Participante oparti) {
            return base.Channel.FiltList(oparti);
        }
        
        public System.Threading.Tasks.Task<AccesoDatos.Entidades.Participante[]> FiltListAsync(AccesoDatos.Entidades.Participante oparti) {
            return base.Channel.FiltListAsync(oparti);
        }
    }
}
